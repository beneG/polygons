...
class YoloDetector {
 public:
   ...
   * @param confidence_threshold Minimum confidence for detections (default:
   * 0.5)
  ...
  YoloDetector(const std::string& model_config_file,
               ...
               float confidence_threshold = 0.5f, float nms_threshold = 0.4f);
 ...
 private:
  ...
  std::unordered_map<std::string, int>
      class_name_to_id_;  ///< Map from class name to ID
